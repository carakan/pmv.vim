function! nodejs#hexApi#getPackageInfo(package)
...
function! nodejs#hexApi#getAllReleases(package)
  let l:json = nodejs#hexApi#fetchPackage(a:package)
...
function! nodejs#hexApi#getLatestRelease(package)
  let l:json = nodejs#hexApi#fetchPackage(a:package)
  if has_key(l:json, 'releases')
...
function! nodejs#hexApi#fetchPackage(package)
  echom 'Retrieving information from hex.pm ...'
